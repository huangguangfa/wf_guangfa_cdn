<template>
    <div class="header">
        <div class="header-content">
            ...
            <div class="ui_btn">
                <el-button type="success" size="mini" @click="toPage('https://huangguangfa.cn')">个人博客</el-button>
                <el-button type="primary" size="mini" style="margin-left:5px" @click="toPage('http://fcwui.huangguangfa.cn')">个人UI库</el-button>
            </div>
...
<script>
    import systemModule from '../utils/systemModule.json';
